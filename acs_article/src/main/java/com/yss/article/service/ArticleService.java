...
import com.yss.article.dao.ArticleDao;
...
public class ArticleService {
    ...
    public Article findById(String id) {
        ...
        //判断redis里面是否存在
        if (article == null) {
            System.out.println("redis没有文章, 从mysql获得..");
            //从mysql获得
    ...
    public void examine(String articleId) {
        Article article = articleDao.findById(articleId).get(); //持久态对象
        //设置state改成1
        article.setState("1");
        //更新 articleDao.save(article);
